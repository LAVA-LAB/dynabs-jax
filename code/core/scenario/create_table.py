...
def create_table(N, beta, kstep, trials, export=False, filepath=False):
    d = 1
...
if __name__ == '__main__':
    ...
    ax1.errorbar(N_list, average_lb[b0], yerr=std_lb[b0], capsize=2, linewidth=lw,
                 label=r'Scenario $\beta = ' + str(b0) + '$', color='grey')
    ax1.errorbar(N_list, average_ub[b0], yerr=std_ub[b0], capsize=2, linewidth=lw, color='grey')

    ax1.errorbar(N_list, hoeff_avg_lb[b0], yerr=hoeff_std_lb[b0], capsize=2, linewidth=lw,
                 label=r'Hoeffding $\beta = ' + str(b0) + '$', color='blue')
    ax1.errorbar(N_list, hoeff_avg_ub[b0], yerr=hoeff_std_ub[b0], capsize=2, linewidth=lw, color='blue')

    ax1.errorbar(N_list, average_lb[b1], yerr=std_lb[b1], capsize=2, linewidth=lw,
                 label=r'Scenario $\beta = ' + str(b1) + '$', color='k')
    ax1.errorbar(N_list, average_ub[b1], yerr=std_ub[b1], capsize=2, linewidth=lw, color='k')

    ax1.errorbar(N_list, hoeff_avg_lb[b1], yerr=hoeff_std_lb[b1], capsize=2, linewidth=lw,
                 label=r'Hoeffding $\beta = ' + str(b1) + '$', color='green')
